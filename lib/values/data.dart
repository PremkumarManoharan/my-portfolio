...
class Data {
  ...
  static List<CertificationData> certificationData = [
    ...
    CertificationData(
      title: StringConst.CKA,
      url: StringConst.CKA_URL,
      image: ImagePath.CKA_CERT,
      imageSize: 0.325,
      awardedBy: StringConst.LINUX,
    ),
    CertificationData(
      title: StringConst.TERRAFORM,
      url: StringConst.TERRAFORM_URL,
      image: ImagePath.TERRAFORM_CERT,
      imageSize: 0.325,
      awardedBy: StringConst.HASHICORP,
    ),
  ];
